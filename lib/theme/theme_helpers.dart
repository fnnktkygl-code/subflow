...
class SubscriptionOccurrence {
  ...
  @override
  String toString() =>
      'SubscriptionOccurrence(${subscription.name}, ${DateFormat('yyyy-MM-dd').format(date)})';
}
...
class CalendarHelpers {
  ...
  // AMOUNT FORMATTING
  // ===================================================================
  /// Format amount with optional blur and proper currency symbol
